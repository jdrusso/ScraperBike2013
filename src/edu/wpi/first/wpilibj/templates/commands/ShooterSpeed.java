...
public class ShooterSpeed extends PIDCommand {
    ...
    public ShooterSpeed(double Kp, double Ki, double Kd){
        ...
        this.shootController = ScraperBike.getShooterController(); 
    ...
    protected void calculateVelocity(){
        ...
        setpoint = RobotMap.range*Math.sqrt(gravity/((RobotMap.range*Math.tan(angleRadians))-(RobotMap.target3Height)+RobotMap.shooterHeight))/(Math.sqrt(2.0)*Math.cos(angleRadians));
